  ...
  const handleProcess = async () => {
    ...
    try {
      ...
      try {
        ...
        toast.error(
          "Invalid JSON file. Please make sure you're uploading the output from 'npx ccusage daily --json' → Make sure you're uploading the file generated from step 1",
          {
            style: {
              background: '#374151',
              color: '#fff',
      ...
      toast.error(
        `Error processing file: ${error instanceof Error ? error.message : 'Unknown error'}. Check console for details.`,
        {
          style: {
            background: '#374151',
            color: '#fff',
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-gray-400 text-[10px] sm:text-xs">
                          📁 File saved to your <strong>Desktop</strong> as{' '}
