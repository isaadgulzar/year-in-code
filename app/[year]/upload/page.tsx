...
export default function UploadPage() {
  ...
  return (
    <div className="h-screen bg-linear-to-br from-gray-900 via-gray-800 to-black text-white flex flex-col overflow-hidden">
      {/* Header */}
                    ...
                    <div className="flex-1">
                      ...
                      <div className="mb-2">
                        ...
                        <div className="relative group">
                          <div className="bg-gray-900 rounded p-2 pr-8 font-mono text-xs text-green-400 overflow-x-auto">
                      ...
                      <p className="text-gray-400 text-xs">
                        📁 File saved to your <strong>Desktop</strong> as <code className="bg-gray-700 px-1 rounded">my-wrapped-{year}.json</code>
                      </p>
                    </div>
                  </div>
                </div>
